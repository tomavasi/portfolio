...
export default function Projects() {
  ...
  return (
    <div className={`relative bg-[#EBE4D1] ${fonts.cairo.className} p-2 border-r text-black shadow shadow-black rounded-lg min-h-[70%] w-[100%] flex flex-col justify-evenly items-center scale-0 animate-appear2 [animation-timeline:scroll()] [animation-range:0%_50%]`}>
      ...
      <div className='h-[25%] w-[80%] lg:w-[70%]'>
        <ProjectCard title="LQS" react css icon={<FaTransgender />} text='My first attempt in Web Developement, which advanced into a full-stack project. Search your products and put them in the cart. Fill in the form to register and login! ' urlGit='https://github.com/tomavasi/full-stack-lqs' urlWebsite='https://full-stack-lqs.onrender.com/' />
      </div>
      <div className='h-[25%] w-[80%] lg:w-[70%]'>
